...
class tripDateModule {
    runStartTripDatePicker(bot, msg) {
        ...
        this.sendCalendar(
            getLocalizedMessage(keysActions.CALENDAR_START_TRIP_KEY, msg),
            true
        );
    }
    ...
    async sendCalendar() {
        ...
        const congratsMessage = isStartDateCreatingCompleted
            ? getLocalizedMessage(
                  keysActions.CALENDAR_CONGRATS_MESSAGES_STOP_KEY,
                  this.msg
              )
            : getLocalizedMessage(
                  keysActions.CALENDAR_CONGRATS_MESSAGE_START_KEY,
                  this.msg
              );
        ...
        sendMessage(
            ...
            this.msg.chat.id,
            getLocalizedMessage(
                keysActions.CALENDAR_HELP_MESSAGE_KEY,
                this.msg
            ),
            {
                parse_mode: 'HTML',
                ...calendarKeyboard(
                    getLocalizedMessage(
                        keysActions.BLOCKED_GO_TO_TIME_PICKER_KEYBOARD_KEY,
                        this.msg
                    ),
                    this.msg
                ),

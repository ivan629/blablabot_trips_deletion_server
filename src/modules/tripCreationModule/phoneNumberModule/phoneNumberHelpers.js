...
import {
    phoneNumberKeyboard,
    phoneNumberKeyboardGoToSummarise,
...
export const sendPhoneNumberInitialData = (bot, msg) => {
    sendMessage(
        ...
        msg.chat.id,
        getLocalizedMessage(
            keysActions.SHARE_CARRIER_PHONE_NUMBER_MESSAGE_KEY,
            msg
        ),
        {
            parse_mode: 'HTML',
        ...
        bot.once('contact', async (query) => {
            ...
            await sendMessage(
                ...
                chat.id,
                getLocalizedMessage(
                    keysActions.SAVED_PHONE_NUMBER_MESSAGES_KEY,
                    msg
            ...
            await sendMessage(
                ...
                chat.id,
                getLocalizedMessage(
                    keysActions.GO_TO_TRIP_SUMMARISE_HELP_TEXT_MESSAGES_KEY,
                    query
                ),

...
import {
    handlePriceSetting,
    sendTripPriceBlockedMessage,
} from './tripPriceControllers';
import {
    getIsTripPriceSettings,
    toggleIsTripPriceCreating,
    ...
    bot.on('message', async (msg) => {
        ...
        if (
            ...
            return sendMessage(
                ...
                msg.chat.id,
                getLocalizedMessage(
                    keysActions.SET_TRIP_PRICE_INITIAL_MESSAGES_KEY,
                    msg
                ),
        ...
        if (
            listenerCase(keysActions.CONFIRM_TRIP_PRICE_MESSAGE_KEY, msg.text)
        ) {

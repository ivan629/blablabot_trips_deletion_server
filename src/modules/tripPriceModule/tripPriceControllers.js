import { tripPriceSettingsKeyboardFinish, tripPriceSettingsKeyboardInitial } from '../keyboards/keyboards';
import { setTripPrice } from '../../services/helpers';
import { sendMessage } from '../../common/utils/utils';
import {
    TRIP_PRICE_SETTINGS_FINISH_MESSAGE,
    TRIP_PRICE_SETTINGS_INITIAL_MESSAGE,
    TRIP_PRICE_SETTINGS_INCORRECT_PRICE_MESSAGE,
...
export const handlePriceSetting = async (bot, msg, id) => {
    ...
    if (isOnlyNumbers) {
        ...
        sendMessage(bot, id, TRIP_PRICE_SETTINGS_INCORRECT_PRICE_MESSAGE);
    }
};

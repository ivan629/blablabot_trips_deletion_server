...
} from '../../common/messages/tripCreationMessages/availableSeatsKeysActions';
import {
    ...
    reply_markup: {
        ...
        keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.SEND_MY_PHONE_NUMBER_MESSAGES_KEY,
                        eventObject
                    ),
            ...
            [
                {
                    text: getLocalizedMessage(
                        keysActions.GO_TO_THE_MAIN_MENU_MESSAGES_KEY,
                        eventObject
                    ),
    ...
    reply_markup: {
        ...
        keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.CONFIRM_TRIP_PRICE_BLOCKED_MESSAGES_KEY,
                        eventObject
                    ),
                },
            ],
...
export const availableSeatsKeyboard = (eventObject) => ({
    reply_markup: {
        inline_keyboard: chunk(
            new Array(8).fill(null).reduce((result, item, index) => {
                result.push({
                    text: index + 1,
                    callback_data: createAction(
                        SET_AVAILABLE_SEATS_CUNT,
    ...
    reply_markup: {
        ...
        keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.GO_TO_TRIP_PRICE_SETTINGS_MESSAGES_KEY,
                        eventObject
                    ),
                },
            ],
    ...
    reply_markup: {
        ...
        keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.GO_TO_TRIP_PRICE_SETTINGS_MESSAGES_BLOCKED_KEY,
                        eventObject
                    ),
                },
            ],
    ...
    reply_markup: {
        ...
        keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.MY_TRIPS_MESSAGES_KEY,
                        eventObject
                    ),
                },
            ],
            [
                {
                    text: getLocalizedMessage(
                        keysActions.FIND_TRIP_ACTION_MESSAGES_KEY,
                        eventObject
                    ),
                },
            ],
...
export const findTripsDaysAndCalendarKeyboard = (eventObject) => ({
    reply_markup: {
        inline_keyboard: chunk(
            new Array(4).fill(null).reduce((result, item, index) => {
                result.push({
                    text: getLocalizedMessage(
...
export const myTripsTripActionKeyboard = ({
    trip_id,
    ...
    reply_markup: {
        ...
        keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.SHOW_BOOKED_TRIPS_MESSAGES_KEY,
                        eventObject
                    ),
                },
                {
                    text: getLocalizedMessage(
                        keysActions.SHOW_I_AM_DRIVING_MESSAGES_KEY,
                        eventObject
                    ),
                },
            ],
    ...
    reply_markup: {
        ...
        inline_keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.UNBOOK_TRIP_MESSAGES_KEY,
                        eventObject
                    ),
                    callback_data: createAction(
                        CANCEL_TRIP_BOOKING_ACTION,
    ...
    reply_markup: {
        ...
        inline_keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.REMOVE_TRIP_BUTTON_MESSAGES_KEY,
                        eventObject
                    ),
                    callback_data: createAction(
                        keysActions.REMOVE_TRIP_BUTTON_ACTION,
                        trip_id
                    ),
                },
                {
                    text: getLocalizedMessage(
                        keysActions.TRIP_PASSENGERS_BUTTON_MESSAGES_KEY,
                        eventObject
                    ),
                    callback_data: createAction(
                        keysActions.TRIP_PASSENGERS_BUTTON_ACTION,
                        trip_id
                    ),
                },
            ],
    ...
    reply_markup: {
        ...
        keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.BLOCKED_GO_TO_TRIP_END_TIME_PICKER_MESSAGE_KEY,
                        eventObject
                    ),
                },
            ],
    ...
    reply_markup: {
        ...
        keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.BLOCKED_FINAL_CITY_IN_THE_TRIP_MESSAGES,
                        eventObject
                    ),
                },
            ],
    ...
    reply_markup: {
        ...
        keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.FIND_TRIP_GO_TO_CALENDAR_BLOCKED_ACTION_MESSAGES_KEY,
                        eventObject
                    ),
                },
            ],
    ...
    reply_markup: {
        ...
        keyboard: [
            [
                {
                    text: getLocalizedMessage(
                        keysActions.FIND_TRIP_GO_TO_CALENDAR_MESSAGES_KEY,
                        eventObject
                    ),
                },
            ],

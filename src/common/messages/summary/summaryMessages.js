...
export const TRIP_SUMMARY_MESSAGES = {
    [uk]: ({
        ...
        const phoneNumber = `${leftPadding}☎️ <b>Контактний номер</b>  ${Object.values(
            carrierInfo.phone_numbers
        ).map((number) => getFormattedPhoneNumber(number))} `;
    ...
    [ru]: ({
        ...
        const phoneNumber = `${leftPadding}☎️ <b>Контактный номер:</b>  ${Object.values(
            carrierInfo.phone_numbers
        ).map((number) => getFormattedPhoneNumber(number))} `;
    ...
    [en]: ({
        ...
        const phoneNumber = `${leftPadding}☎️ <b>Phone number:</b>  ${Object.values(
            carrierInfo.phone_numbers
        ).map((number) => getFormattedPhoneNumber(number))} `;

...
export const SET_TRIP_PRICE_INITIAL_MESSAGES = {
    [uk]: 'Введіть ціну поїздки будь ласка 🤑',
    [ru]: 'Введите цену поездки пожалуйста 🤑',
    [en]: 'Enter the price of the trip please 🤑',
}

export const GO_TO_TRIP_PRICE_SETTINGS_MESSAGES = {
    [uk]: '✅ Вказати ціну поїздки 💰',
...
export const TRIP_PRICE_SETTINGS_FINISH_MESSAGES = {
    [uk]: 'Натисніть <b>✅ Підтвердити ціну</b>',
    [ru]: 'Нажмите <b>✅ Подтвердить цену</b>',
    [en]: 'Press <b>✅ Confirm the price</b>',
}

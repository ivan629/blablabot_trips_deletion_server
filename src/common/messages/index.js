...
const myTripsMessagesMap = {
    ...
    [myTripsKeysActions.TRIP_PASSENGERS_BUTTON_MESSAGES_KEY]: myTripsMessages.TRIP_PASSENGERS_BUTTON_MESSAGES,
    [myTripsKeysActions.NO_PASSENGERS_MESSAGES_KEY]: myTripsMessages.NO_PASSENGERS_MESSAGES,
    [myTripsKeysActions.NOT_FOUNT_BOOKED_TRIPS_MESSAGES_KEY]: myTripsMessages.NOT_FOUNT_BOOKED_TRIPS_MESSAGES,
}
